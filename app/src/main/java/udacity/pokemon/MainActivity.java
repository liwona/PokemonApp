            ...
            if (jsonString != null) {
                try {
                    ...
                    for (int i = 0; i < pokemons.length(); i++) {
                        ...
                        JSONObject firstAttribute = pokemons.getJSONObject(i);

                        String name = firstAttribute.getString("name");
                        String id = firstAttribute.getString("id");
                        String candy = firstAttribute.getString("candy");
